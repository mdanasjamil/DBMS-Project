...
<header class="headerofpage">
        ...
        <nav>
            <ul class="navbar">
                <li><a href="../index.html"><h5><p style="color:white">Home</p></h5></a></li>
                <li><a href="../about.html"><h5><p style="color:white">About</p></h5></a></li>
                <li><a href="index.php"><h5><p style="color:white">Contact</p></h5></a></li>
                <li><a href="../prices.php"><h5><p style="color:white">Crypto Prices</p></h5></a></li>
            </ul>
        </nav>
        <a href="/phpfiles/login.php" class="cta"><h5><p style="color:white">Login</p></h5></a>
    </header>
